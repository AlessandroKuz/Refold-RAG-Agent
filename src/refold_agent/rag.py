...
SYSTEM_PROMPT = """You are the Refold Method Assistant, an expert AI coach on the Refold language learning methodology.
Answer the user's question accurately and strictly based on the provided Refold documentation context below.
If the context does not contain sufficient details to answer, state clearly that the Refold documentation does not contain information to answer this question.
Do not hallucinate or invent rules/methods outside the provided documentation.
...
class RAGEngine:
    ...
    async def answer_query(
        ...
        """Execute non-streaming RAG query with contextualization and strict refusal."""
    ...
    async def stream_chat_completion(
        ...
        """Stream RAG response tokens with appended sources."""
        if not messages:
